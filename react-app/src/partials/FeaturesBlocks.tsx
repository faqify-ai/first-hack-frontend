        ...
        <div className="py-12 md:py-20">
          ...
          <div className="relative max-w-sm mx-auto grid gap-16 md:grid-cols-2 lg:grid-cols-3 lg:gap-y-20 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h3 className="h4 font-playfair-display mb-2">Robust Integrations</h3>
              <p className="text-lg text-slate-500">Seamlessly integrate 20+ products such as Slack, Discord, Confluence, JIRA and more!</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
              ...
              <h3 className="h4 font-playfair-display mb-2">Fix Employee Onboarding</h3>
              <p className="text-lg text-slate-500">Our AI question answering helps any new employee acclimatize faster.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
              ...
              <h3 className="h4 font-playfair-display mb-2">Battle-tested AI</h3>
              <p className="text-lg text-slate-500">Our AI models are industry-grade and can handle a wide variety of complex queries.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="300">
              ...
              <h3 className="h4 font-playfair-display mb-2">Unlimited Questions for scale</h3>
              <p className="text-lg text-slate-500">According to the plan, our system is capable of handling unlimited amounts of repetitive questions in your ecosystem.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="400">
              ...
              <h3 className="h4 font-playfair-display mb-2">Help redirection</h3>
              <p className="text-lg text-slate-500">Beyond getting the answer directly, our system also directs you to people who most likely know what you need.</p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="500">
              ...
              <h3 className="h4 font-playfair-display mb-2">Get your answers quicker</h3>
              <p className="text-lg text-slate-500">Instead of relying and waiting on a senior engineer to answer your query for the 100th time, let our system help you immediately.</p>
            </div>
