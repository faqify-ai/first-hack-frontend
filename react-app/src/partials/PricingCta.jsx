        ...
        <div className="mt-12 md:mt-16">
          ...
          <div className="relative flex flex-col lg:flex-row justify-between items-center bg-white shadow-lg p-6">
            <div className="absolute top-0 left-0 ml-6 -mt-4">
              <div className="inline-flex text-sm font-semibold py-1 px-3 text-emerald-700 bg-emerald-200 rounded-full">For Young Startups, Organizations and Non-profits</div>
            </div>
            <div className="h4 font-playfair-display text-center lg:text-left mb-4 lg:mb-0">Launched a business or organization making less than $100K in revenue?</div>
